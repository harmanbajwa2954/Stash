...
const AccountsPage = async ({ params }) => {
    ...
    return <div className='space-y-8 mx-5 flex gap-4 items-end justify-between'>
        <div>
            <h1 className='text-5xl sm:text-6xl font-bold gradient gradient-title capitalize'>{account.name}</h1>
